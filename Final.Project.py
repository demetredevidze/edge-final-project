...
answer_list = "yes" and "Yes" and "YES" and "sure" and "SURE" and "Sure" and "yeah" and "YEAH" and "Yeah" and "yep"
lets_start = "Great decision " +user_name+ "! " +level+ "\n" +help3+ "\n" +num_of_tries

print("Hi " +user_name+ ", would you like to play a game on guessing random integers?")
play_game = input()

if play_game == "yes" and "Yes" and "YES" and "sure" and "SURE" and "Sure" and "yeah" and "YEAH" and "Yeah" and "yep":
    print(lets_start)
    lev_of_diff = input()
